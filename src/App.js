...
const App = () => {
	...
	const addIngredientsList = useRecipesStore(state => state.addIngredientsList)
	const recipesList = useRecipesStore(state => state.recipes)
					...
					<li>
						<div className="recipe-card">
							...
							<div className="recipe-step">
								...
								<img src={require('./assets/images/framed-egg-1.jpg')} alt="Step 1"/>
							</div>
							<div className="command-bar">
								{/* Placeholder to keep flex style */}<span></span>
								<button>Next</button>
							</div>
						</div>
					</li>
